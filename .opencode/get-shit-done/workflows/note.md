...
- **Global scope**: `/Users/kritbannachaisirisuk/Documents/work-dir/openpos/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kritbannachaisirisuk/Documents/work-dir/openpos/.opencode/notes/`)
...
2. Glob `/Users/kritbannachaisirisuk/Documents/work-dir/openpos/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kritbannachaisirisuk/Documents/work-dir/openpos/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kritbannachaisirisuk/Documents/work-dir/openpos/.opencode/notes/` — works in any directory
