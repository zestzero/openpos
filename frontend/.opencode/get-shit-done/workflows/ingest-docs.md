...
```bash
INIT=$(node "/Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
