...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.opencode/agents/gsd-eval-planner.md for instructions.
