...
const copy = posLocale === 'th' ? {
  ...
  searchFallback: 'หรือค้นหาด้วยชื่อสินค้า', noMatch: 'ไม่พบสินค้า', itemNotFound: 'ไม่พบสินค้านี้', cameraUnavailable: 'กล้องไม่พร้อมใช้งาน',
  ...
  searchFallback: 'Or search by product name', noMatch: 'No matching product', itemNotFound: 'Item not found', cameraUnavailable: 'Camera unavailable',
