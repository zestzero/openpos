...
- **Global scope**: `/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/notes/`)
...
2. Glob `/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/notes/` — works in any directory
