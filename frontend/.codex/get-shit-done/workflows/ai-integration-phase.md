...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/zestzero/Documents/work-dir/openpos/frontend/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/zestzero/Documents/work-dir/openpos/frontend/.codex/agents/gsd-eval-planner.md for instructions.
